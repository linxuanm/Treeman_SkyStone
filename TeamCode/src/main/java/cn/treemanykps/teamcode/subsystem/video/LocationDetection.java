...
import org.firstinspires.ftc.teamcode.subsystem.video.VuforiaFactory;
...
//        parameters.cameraDirection   = CAMERA_CHOICE;
        ...
        vuforia = VuforiaFactory.defaultInstance(hardwareMap);
    ...
    /***
     *
     * @return 返回识别到的机器人坐标对象，如果没有识别到则返回null
     */
    public OpenGLMatrix detect(){
        targetVisible = false;
        for (VuforiaTrackable trackable : allTrackables) {
